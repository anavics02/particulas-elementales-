...
if st.button ("Quarks"):
  ...
  with col1:
    st.ma_rkdown('''**Arriba_(up).** Dotado de un isospín +1/2 como número cuántico.
    **Abajo_(down).** Dotado de un isospín -1/2 como número cuántico.
    **Encanto_(charm).** Dotado de un encanto +1 como número cuántico.
    **Extraño_(strange).** Dotado de una extrañeza -1 como número cuántico.
    **Tope_(top)_o_verdad_(truth).** Dotado de una superioridad (topness) +1.
    **Fondo_(bottom)_o_belleza_(beauty).**Dotado de una inferioridad (bottomness) -1.''')
